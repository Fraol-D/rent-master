...
const DashboardPage: React.FC<props> = ({
  ...
  //   () => import('../Dashboard Wigets/DashbTotalCollected')
  // );
  // const DashbNetProfitTotalCollected = (
  //   () => import('../Dashboard Wigets/DashbNetProfitTotalCollected')
  // );
    ...
    <>
      {DashboardSelectedPage === 'Overview' ? (
        ...
        >
          ...
          <DashbMonthlyExpenseTrendWidget SelectedBranchId={SelectedBranchId} />
          <DashbExpenseHistory />
      ...
      ) : DashboardSelectedPage === 'TenantsList' ? (
        <>
                     {' '}
                  ...
                  >
                    ...
                    <td className="InfoTableBodyTD">
                      ...
                      <div className="EmailInfoTable">
                                                 {' '}
                        {highlightText(tenant.email.toLowerCase(), mainSearch)} 
                                             {' '}
                      </div>
                                           {' '}
                    </td>
                    ...
                    <td
                      className="InfoTableBodyTD"
                      title={toEthiopianDateString(new Date(tenant.AddedTime))}
                    >
                                               {' '}
                      {highlightText(
                  ...
                  <tbody>
                    ...
                    {Agreements.filter(
                      ...
                      >
                        ...
                        <td className="InfoTableBodyTD">
                                                       {' '}
                          {highlightText(agreement.Memo === 'INITIALLLI' ? 'None' : agreement.Memo, mainSearch)}           
                                         {' '}
                        </td>
                                                   {' '}
                        <td className="InfoTableBodyTD">
                        ...
                        <td className="InfoTableBodyTD">
                                                       {' '}
                          {highlightText(agreement.representative, mainSearch)} 
                                                   {' '}
                        </td>
                                                   {' '}
                        <td className="InfoTableBodyTD">
      ...
      ) : DashboardSelectedPage === 'BrokersList' ? (
        <div className="InfoTableContainer">
          <table className="InfoTable" style={{ width: 'var(--1000px-V)' }}>
            <thead className="InfoTableThead">
              <tr className="InfoTableHeadTR">
                {['#', 'Name', 'Tel', 'Recommended Tenants', 'Added Time'].map(
                  (col, index) => (
                    <th
                      key={index}
                      className="InfoTableHeadTh"
              ...
              {filteredData(
                ...
                >
                  ...
                  <td className="InfoTableBodyTD">
                    ...
                    {broker.email && (
                      <div className="EmailInfoTable">
                        {highlightText(broker.email.toLowerCase(), mainSearch)}
                      </div>
                    )}
                  </td>
                  <td className="InfoTableBodyTD PhoneNumberInfoTableContainer">
                          ...
                          >
                            <span style={{ fontWeight: 'bold' }}>
                              {highlightText(
                                AllTenants.find(
                                  (t: tenant) =>
                                    t.id === recommendation.recommendedTenantId
                                )?.name || '',
                                mainSearch
                              )}
                            </span>
      ...
      ) : DashboardSelectedPage === 'TenantReviews' ? (
        <>
          <table className="InfoTable">
            <thead className="InfoTableThead">
              <tr className="InfoTableHeadTR">
