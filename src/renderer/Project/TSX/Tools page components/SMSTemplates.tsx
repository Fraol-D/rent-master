  ...
  return (
    <div className="tools-page">
      ...
      >
        ...
        <button id="add-sms-template-button" onClick={handleAddSMSTemplate}>
          Add an SMS template
        </button>
      </div>
      {smsTemplates
            ...
            {openTemplateId === template.id && (
              <div className="email-template-content">
                ...
                <div className="email-template-variables">
                  ...
                  {editingTemplateId === template.id ? (
                    <>
                      <div id="sms-variables-list" className="variable-buttons">
                      ...
                      <button
                        ...
                        onClick={() => handleTryOut(template.id)}
                      >
                        Send / Try Out
                      </button>
                    </>
            ...
            {tryOutMode === template.id && (
              <>
                ...
                <div className="try-out-container">
                  ...
                  >
                    <h3>Send SMS</h3>Exmple format 0911223344 .Will count as{' '}
                    {calculateSMSInfo(replaceVariables(template.body)).count}{' '}
                    SMS
                  </div>
                  <p>
                    You will now send the above SMS to the phone number
                    specified below
                  </p>
                  <input
                    type="text"
